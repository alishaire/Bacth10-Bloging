...
const page = () => {
  return (
    <div className='max-w-fit'>
        <body className="flex m-0  w-screen h-screen p-0  bg-gray-300">
	<div className="fixed left-0  top-0 bottom-0  min-w-40 flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
